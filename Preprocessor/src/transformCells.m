clear all
CellsFileName='C:\Users\ncasas\Documents\MELODY_RESU\MODELE_2\M2-matrices\matrice seule\20x2\creation\data_matrix_20x2_1.asc';
% GrainsFileName='C:\CODES\Cvoro2D\Executables\Gouge_Matrix_Sample50_01.mat';
Criterion='Centre';
Window=[-0.01,20.01,0,2];
...
print('Cells_22.png','-dpng','-r300')
save('Matrix_22.mat','Cells','Vertices','Contours')
